        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <a href="mailto:info@planconstruction.org" className="text-sm hover:text-secondary transition-colors">
                info@planconstruction.org
              </a>
            </div>
            <div className="flex items-center space-x-2">
              <Phone className="w-4 h-4" />
              <a href="tel:+252636379790" className="text-sm hover:text-secondary transition-colors">
                +252 63 6379790
              </a>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="https://wa.me/252636379790" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors">
